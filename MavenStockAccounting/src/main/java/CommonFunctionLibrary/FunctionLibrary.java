...
public class FunctionLibrary 
{
	...
	public static WebDriver startBrowser(WebDriver driver) throws Throwable
	{
		if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("firefox"))
		{
			...
			{
				System.setProperty("webdriver.chrome.driver", "C:\\Users\\satyasree.d\\workspace\\MavenStockAccounting\\ExecutableFiles\\chromedriver.exe");
...
public static void supplierCreation(WebDriver driver,String locatorType,String locatorValue,String data)
{
	if(locatorType.equalsIgnoreCase("id"))
	{
		driver.findElement(By.id(locatorValue)).sendKeys(data);
...
public static void captureData(WebDriver driver,String locatorType,String locatorValue) throws Throwable
{
	...
	FileWriter fw=new FileWriter("C:\\Users\\satyasree.d\\workspace\\MavenStockAccounting\\CaptureData\\Data.txt");
	...
	{
		java.io.FileReader fr=new java.io.FileReader("C:\\Users\\satyasree.d\\workspace\\MavenStockAccounting\\CaptureData\\Data.txt");
	...
	//StockCategories table validaton                      
	...
	//Stock Items
	public static void stockItems(WebDriver driver,String locatorType,String locatorValue)
	{
	...
	public static void stockCategories(WebDriver driver,String locatorType,String locatorValue,String data)
	{
